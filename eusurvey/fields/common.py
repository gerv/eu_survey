...
def get_label(input_element, document):
    """Determines the label for an input_element."""
    input_id = input_element.attrib["id"]
    label = get(document.xpath('.//label[@for="%s"]' % input_id))
    remove_elements = (
